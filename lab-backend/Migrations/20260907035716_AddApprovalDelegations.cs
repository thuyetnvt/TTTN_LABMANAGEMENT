    ...
    public partial class AddApprovalDelegations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApprovalDelegations_Users_RevokedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalDelegations_DelegateUserId_IsActive_StartsAt_EndsAt",
                table: "ApprovalDelegations",
                columns: new[] { "DelegateUserId", "IsActive", "StartsAt", "EndsAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalDelegations_DelegatorUserId_IsActive",
                table: "ApprovalDelegations",
                columns: new[] { "DelegatorUserId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalDelegations_RevokedByUserId",
                table: "ApprovalDelegations",
