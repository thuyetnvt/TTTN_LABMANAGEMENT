...
namespace LabManagementAPI.Migrations
{
    ...
    [Migration("20260909024413_AddEquipmentResponsibilityUsers")]
    partial class AddEquipmentResponsibilityUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LabManagementAPI.Models.ApprovalDelegation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DelegateUserId", "IsActive", "StartsAt", "EndsAt");
            ...
            modelBuilder.Entity("LabManagementAPI.Models.HandoverIssueEvidence", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("HandoverIssueReportId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HandoverIssueReportId", "UploadedAt");

                    b.ToTable("HandoverIssueEvidence");
                });

            modelBuilder.Entity("LabManagementAPI.Models.HandoverIssueReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HandoverRecordId", "Status");

                    b.HasIndex("HandoverRecordId", "EquipmentId", "Status");

                    b.ToTable("HandoverIssueReports");
                });
            ...
            modelBuilder.Entity("LabManagementAPI.Models.ApprovalDelegation", b =>
                {
                    b.HasOne("LabManagementAPI.Models.User", "DelegateUser")
                        .WithMany()
                        .HasForeignKey("DelegateUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LabManagementAPI.Models.User", "DelegatorUser")
                        .WithMany()
                        .HasForeignKey("DelegatorUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LabManagementAPI.Models.User", "RevokedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LabManagementAPI.Models.ConsumableRequest", b =>
                {
                    ...
                    b.HasOne("LabManagementAPI.Models.User", "RejectedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LabManagementAPI.Models.HandoverIssueEvidence", b =>
                {
                    b.HasOne("LabManagementAPI.Models.HandoverIssueReport", "HandoverIssueReport")
                        .WithMany("Evidence")
                        .HasForeignKey("HandoverIssueReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("HandoverIssueReport");
            ...
            modelBuilder.Entity("LabManagementAPI.Models.HandoverIssueReport", b =>
                {
                    ...
                    b.HasOne("LabManagementAPI.Models.User", "ReportedByUser")
                        .WithMany()
                        .HasForeignKey("ReportedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LabManagementAPI.Models.User", "ResolvedByUser")
                        .WithMany()
