export default {
  landing: {
    ...
    heroSubtitle: 'Theo dõi tài sản, mượn trả, bảo trì và vật tư trong một nền tảng thống nhất.',
    ...
    f3Title: 'Bảo trì và sửa chữa',
    f3Desc: 'Kiểm tra tình trạng sau khi trả và theo dõi lịch sử sửa chữa.',
