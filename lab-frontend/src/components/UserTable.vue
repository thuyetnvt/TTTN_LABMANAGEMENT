...
const columns = [
  ...
  { title: 'Trạng thái', dataIndex: 'isActive', key: 'isActive', sortKey: 'isActive', sortable: true, width: 145, align: 'center', className: 'status-column', filterType: 'select', filterKey: 'status', filterOptions: [
