export const STATUS = Object.freeze({
  ...
  MAINTENANCE_COMPLETING: 'MAINTENANCE_COMPLETING',
  MAINTENANCE_COMPLETED: 'MAINTENANCE_COMPLETED',
  CONSUMABLE_PENDING: 'CONSUMABLE_PENDING',
  CONSUMABLE_PROCESSING: 'CONSUMABLE_PROCESSING',
  CONSUMABLE_APPROVED: 'CONSUMABLE_APPROVED',
  CONSUMABLE_HANDED_OVER: 'CONSUMABLE_HANDED_OVER',
  CONSUMABLE_RECEIVED: 'CONSUMABLE_RECEIVED',
  CONSUMABLE_ISSUED: 'CONSUMABLE_ISSUED',
  INVENTORY_OPEN: 'INVENTORY_OPEN',
  INVENTORY_REVIEWING: 'INVENTORY_REVIEWING',
...
const LEGACY_STATUS = Object.freeze({
  ...
  'Đang xử lý duyệt': STATUS.APPROVAL_PROCESSING,
  ...
  'Hết hạn giữ chỗ': STATUS.EXPIRED,
  'Hỏng': STATUS.BROKEN,
  'Thất lạc tài sản': STATUS.MISSING,
  'Đang xử lý': STATUS.MAINTENANCE_IN_PROGRESS,
  'Hoàn tất': STATUS.MAINTENANCE_COMPLETED,
  'Hoàn thành': STATUS.MAINTENANCE_COMPLETED,
  'Đã cấp phát': STATUS.CONSUMABLE_RECEIVED,
  'Đã duyệt cấp phát': STATUS.CONSUMABLE_APPROVED,
  'Đã bàn giao vật tư': STATUS.CONSUMABLE_HANDED_OVER,
  'Đã nhận vật tư': STATUS.CONSUMABLE_RECEIVED,
  'Đang kiểm kê': STATUS.INVENTORY_OPEN,
  'Đang đối soát': STATUS.INVENTORY_REVIEWING,
...
export const statusLabel = (value) => ({
  ...
  [STATUS.BORROW_PENDING]: 'Đã giữ chỗ',
  [STATUS.TEACHER_PENDING]: 'Chờ giảng viên duyệt',
  [STATUS.APPROVAL_PROCESSING]: 'Đang xử lý duyệt',
  ...
  [STATUS.EXPIRED]: 'Hết hạn giữ chỗ',
  [STATUS.BROKEN]: 'Hỏng',
  [STATUS.MISSING]: 'Thất lạc',
  [STATUS.MAINTENANCE_IN_PROGRESS]: 'Hỏng',
  [STATUS.MAINTENANCE_COMPLETING]: 'Hỏng',
  [STATUS.MAINTENANCE_COMPLETED]: 'Hỏng',
  [STATUS.CONSUMABLE_PENDING]: 'Chờ duyệt cấp phát',
  [STATUS.CONSUMABLE_PROCESSING]: 'Đang xử lý cấp phát',
  [STATUS.CONSUMABLE_APPROVED]: 'Đã duyệt, chờ bàn giao',
  [STATUS.CONSUMABLE_HANDED_OVER]: 'Đã bàn giao, chờ xác nhận',
  [STATUS.CONSUMABLE_RECEIVED]: 'Đã nhận vật tư',
  [STATUS.CONSUMABLE_ISSUED]: 'Đã cấp phát',
  [STATUS.INVENTORY_OPEN]: 'Đang kiểm kê',
  [STATUS.INVENTORY_REVIEWING]: 'Đang đối soát',
...
export const statusColor = (value) => ({
  ...
  [STATUS.MAINTENANCE_COMPLETED]: 'red',
  [STATUS.BORROW_PENDING]: 'orange',
  [STATUS.TEACHER_PENDING]: 'orange',
  [STATUS.APPROVAL_PROCESSING]: 'blue',
  ...
  [STATUS.MAINTENANCE_IN_PROGRESS]: 'red',
  [STATUS.MAINTENANCE_COMPLETING]: 'red',
  [STATUS.CONSUMABLE_PENDING]: 'orange',
  [STATUS.CONSUMABLE_PROCESSING]: 'blue',
  [STATUS.CONSUMABLE_APPROVED]: 'cyan',
  [STATUS.CONSUMABLE_HANDED_OVER]: 'purple',
  [STATUS.CONSUMABLE_RECEIVED]: 'green',
  [STATUS.CONSUMABLE_ISSUED]: 'green'
  ,[STATUS.INVENTORY_OPEN]: 'blue'
  ,[STATUS.INVENTORY_REVIEWING]: 'purple'
